                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border border-gray-600 px-3 py-2">
                                    {{ $subject->description ?? 'Not Available' }}</td>
                                <td class="border border-gray-600 px-3 py-2">
                                    <button class="inline-block px-2"><img class="text-red-500"
                                            src="{{ asset('icons/pencil-square.svg') }}" alt="Edit Level"></button>
                                    <button class="inline-block px-2"><img src="{{ asset('icons/trash.svg') }}"
